<template>
  ...
  >
    <el-submenu :show-timeout="100" :index="constants.PATH_EMPLOYEE_MY">
      ...
      <el-menu-item
        :class="{'is-active':[constants.PATH_EMPLOYEE_TEAM].includes($route.path)}"
    ...
    <el-submenu :show-timeout="100" :index="constants.PATH_MY_CULTURE_GRADE">
      ...
      <el-menu-item
        :class="{'is-active':[constants.PATH_MY_CULTURE_GRADE].includes($route.path)}"
        :index="constants.PATH_MY_CULTURE_GRADE"
      >我的评分</el-menu-item>
      <el-menu-item
        :class="{'is-active':[constants.PATH_MEMEBER_CULTURE_GRADE,constants.PATH_MEMBER_CULTURE_LIST($route.params.id)].includes($route.path)}"
        :index="constants.PATH_MEMEBER_CULTURE_GRADE"
      >我的下级</el-menu-item>
      <el-menu-item
        :class="{'is-active':[constants.PATH_DOWN_MEMEBER_CULTURE_GRADE,constants.PATH_DOWN_MEMBER_CULTURE_LIST($route.params.id)].includes($route.path)}"
        :index="constants.PATH_DOWN_MEMEBER_CULTURE_GRADE"
      >我的隔级</el-menu-item>
      <el-menu-item
        v-if="show271"
        :class="{'is-active':[constants.PATH_CULTURE_LEVEL].includes($route.path)}"
    ...
    >
      ...
      <el-menu-item
        :class="{'is-active':[constants.PATH_GRADE_PROGRESS($route.params.id),constants.PATH_GRADE_ORG_LIST($route.params.id,$route.params.orgID),constants.PATH_GRADE_EMP_DETAIL($route.params.id,$route.params.orgID,$route.params.uid)].includes($route.path)}"
    ...
    >
      ...
      <el-menu-item
        :class="{'is-active':[constants.PATH_PERFORMANCE_MANAGER,constants.PATH_PERFORMANCE_PROGRESS($route.params.id),constants.PATH_PERFORMANCE_ORG_LIST($route.params.id,$route.params.orgID)].includes($route.path)}"
        :index="constants.PATH_PERFORMANCE_MANAGER"
      >{{constants.GRADE_MANAGE}}</el-menu-item>
      <el-menu-item
        v-if="canSetTpl"
        :class="{'is-active':[constants.PATH_PERFORMANCE_TPL].includes($route.path)}"
        :index="constants.PATH_PERFORMANCE_TPL"
      >{{constants.TPL_SETTING}}</el-menu-item>
      <el-menu-item
        v-if="canSetRules"
        :class="{'is-active':[constants.PATH_PERFORMANCE_RULES].includes($route.path)}"
    ...
    >
      ...
      <el-menu-item
        v-if="showRole"
        :class="{'is-active':[constants.PATH_ACCESS_ROLES].includes($route.path)}"
        :index="constants.PATH_ACCESS_ROLES"
      >{{constants.ROLE_SETTING}}</el-menu-item>
      <el-menu-item
        v-if="showUser"
        :class="{'is-active':[constants.PATH_USER_MANAGE].includes($route.path)}"
