...
隔级确认阶段规则：<br>
1、 根据员工自评和上级评的详情，对文化评分分数和标签进行审核。如无异议，则点击确认。如有异议，点击驳回并填写理由，驳回后由员工的直接上级进行更改。<br>
2、如隔级仅对于员工的评分标签（top/middle/bottom）有异议，需要线下与员工的直接上级沟通后，通过点击“修改”进行标签的更改，更改完成后点击确认，系统会自动通知员工的直接上级；<br>
