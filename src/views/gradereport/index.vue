    ...
    export default {
      ...
      data() {
        return {
          ...
          names: [{label:'测试一',value:'id80'},{label:'测试二',value:'id90'},{label:'测试三',value:'id100'}],
          departments: [{label: '培优事业部', value: 'id001',children: [{label: '哈分校', value: 'id009'},{label: '嘿分校', value: 'id0010'}]},{label: '集团总部', value: 'id002'}],
          currentDepartment: '',

          // 进度饼状图
          progressPieSelf: [{value:335, name:'已完成335人'},{value:700, name:'未完成700人'}],
          progressPieSuperior: [{value:700, name:'已完成335人'},{value:335, name:'未完成700人'}],
          ...
          completionBuNams: ['集团总部','培优事业部','集团总部','培优事业部','集团总部','培优事业部','集团总部','培优事业部','培优事业部','集团总部'],
          // 当前自评/上级评数据
          rateBarActive: 'self',
          ...
          departmentsAverageAll: ['集团总部','培优事业部','集团总部','培优事业部','集团总部','培优事业部','集团总部','培优事业部','培优事业部','集团总部'],
          yMinAll: 0,
          yMaxAll: 20,
          yIntervalAll: 4,
          ...
          departmentsAverageEach: ['集团总部','培优事业部','集团总部','培优事业部','集团总部','培优事业部','集团总部','培优事业部','培优事业部','集团总部'],
          yMinEach: 0,
          yMaxEach: 5,
          yIntervalEach: 1,
          activeTabs: [{label:'成就客户',name:'first'},{label:'务实',name:'second'},{label:'创新',name:'third'},{label:'合作',name:'fourth'}],
      ...
      created() {
        this.conditionForm = {name:this.names[0].value,department:[this.departments[1].value]}
      ...
      methods: {
        ...
        changeDepartment(val) {
          console.log(val)
          this.conditionForm = Object.assign({},this.conditionForm,{department:val})   
        },
        // 某事业部平均分切换自评or上级评数据
        changeBarRate(tab) {
